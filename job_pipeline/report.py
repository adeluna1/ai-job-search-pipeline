...
<section id="audit">{cards or '<p class="empty">No candidates were discovered in this run.</p>'}</section>
<p>Generated {_e(utc_now())}. Manual-review and excluded leads are not application-ready.</p>
</main><script>
