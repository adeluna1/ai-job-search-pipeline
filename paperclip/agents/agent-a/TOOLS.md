...
- `data/agent_a_discovery.json` - board result counts, zero-result coverage, and fallback recommendation.
...
JobSpy is the primary board-discovery boundary. WebClaw remains the direct-page extraction and fallback-search boundary. Do not add ad-hoc scraping code inside Agent A.
